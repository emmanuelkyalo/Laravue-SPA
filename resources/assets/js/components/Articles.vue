  ...
  <h3 class="mx-3 my-3 text-center">My Articles</h3>
          ...
          <div class="row ">
            ...
            <div class=" col-lg-4 card card-body mb-2 "
              v-for="article in articles"
              v-bind:key="article.id"
            >
              <h5> <img height="50" width="50" src="https://img.pngio.com/articles-icon-png-310555-free-icons-library-article-png-200_200.jpg">
          {{ article.title }}  </h5>
              <p>{{ article.body }}</p>
              <p><button   class="btn btn-sm btn-info">Read</button></p>
              <hr />
